...
.. note::
    ...
    Записи фильтров попадают в общий ``ctx`` только если вся цепочка фильтров
    прошла. Если один из фильтров вернул ``False``, изменения, внесённые
    другими фильтрами этой цепочки, отбрасываются и не видны следующим
    хендлерам и роутерам.
