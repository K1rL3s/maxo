...
.. note::
    ...
    цепочки. Если фильтр (или цепочка) не прошёл, все внесённые им изменения
    отбрасываются и не видны следующим хендлерам и роутерам.
    ...
    - Инверсия (``~``, ``InvertFilter``) - никогда не пропускает записи
      вложенного фильтра, ведь она проходит именно тогда, когда тот не прошёл.
