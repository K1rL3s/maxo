...
class BotAddedToChat(MaxUpdate, ChatMethodsFacade):
    ...
    Args:
        chat_id: ID чата или канала, куда был добавлен бот. Как получить ID - в [разделе «Получение chat_id»](https://dev.max.ru/docs-api/use-cases/getting-chat-id)
    ...
    chat_id: int
    """ID чата или канала, куда был добавлен бот. Как получить ID - в [разделе «Получение chat_id»](https://dev.max.ru/docs-api/use-cases/getting-chat-id)"""
    is_channel: bool
